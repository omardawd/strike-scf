...
export async function runPassportRecalculate(orgId: string, locale?: string): Promise<RecalcResult> {
  ...
  const expertAnalysis = await runExpertPassportScoring(orgId, platformData, locale)
